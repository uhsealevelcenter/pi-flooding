    ...
    about_sections_content = [
        ...
        dict(
            ...
            content=[
                ...
                dcc.Markdown(
                    [
                        "- Choose from a list of **predetermined flooding thresholds**\* using the **dropdown menu** displaying the current threshold name.",
                ...
                html.P(
                    [
                        ...
                        " for NOAA tide gauge locations and from an extreme value analysis performed by the ",
                        html.A(
                            "UH Sea Level Center",
                            href="https://uhslc.soest.hawaii.edu",
                            target="_blank",
                        ),
                        " for other stations. The thresholds in this tool were last updated on ",
